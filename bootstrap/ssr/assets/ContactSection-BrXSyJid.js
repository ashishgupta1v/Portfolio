	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({
				...
				id: "contact",
				class: "ct-section"
			}, _attrs))} data-v-3873ffb0><div class="ct-ambient-glow" aria-hidden="true" data-v-3873ffb0></div><div class="ct-shell" data-v-3873ffb0><div class="section-header" data-v-3873ffb0><div class="header-top-row" data-v-3873ffb0><h2 class="section-title" data-v-3873ffb0><span class="section-title-word" data-v-3873ffb0>Let&#39;s Discuss</span><span class="section-title-word accent" data-v-3873ffb0>an Engineering Role</span></h2>`);
			_push(ssrRenderComponent(AvailabilityBadge_default, { class: "contact-availability" }, null, _parent));
			_push(`</div><p class="section-subtitle" data-v-3873ffb0>Open to Senior / Staff Full-Stack Architect &amp; Engineering Lead opportunities (Remote worldwide or Relocation).</p><div class="section-separator" data-v-3873ffb0></div></div><div class="ct-grid" data-v-3873ffb0><div class="ct-column glass-panel" data-v-3873ffb0><h3 class="col-title" data-v-3873ffb0>Direct Contact</h3><a${ssrRenderAttr("href", `mailto:${__props.profile.email}`)} class="ct-email" data-v-3873ffb0>${ssrInterpolate(__props.profile.email)} `);
			_push(ssrRenderComponent(unref(ArrowUpRight), {
				size: 14,
				class: "arrow"
			}, null, _parent));
			_push(`</a>`);
			if (__props.profile.location) _push(`<p class="ct-location" data-v-3873ffb0>${ssrInterpolate(__props.profile.location)} · Remote Worldwide</p>`);
			else _push(`<!---->`);
			if (__props.profile.resumeUrl) {
				_push(`<a${ssrRenderAttr("href", __props.profile.resumeUrl)} download="Ashish-Gupta-Resume.pdf" target="_blank" rel="noopener noreferrer" class="resume-btn glow-pill-violet" style="${ssrRenderStyle({ "margin-bottom": "1.2rem" })}" data-v-3873ffb0> Download Résumé (PDF) `);
				_push(ssrRenderComponent(unref(ArrowUpRight), { size: 14 }, null, _parent));
				_push(`</a>`);
			} else _push(`<!---->`);
			_push(`<div class="schedule-call-wrap" data-v-3873ffb0>`);
			_push(ssrRenderComponent(ScheduleCall_default, null, null, _parent));
			_push(`</div><a${ssrRenderAttr("href", whatsappHref)} target="_blank" rel="noopener noreferrer" class="chat-btn glow-pill" style="${ssrRenderStyle({ "margin-bottom": "1.5rem" })}" data-v-3873ffb0> Message on WhatsApp `);
			_push(ssrRenderComponent(unref(ArrowUpRight), { size: 14 }, null, _parent));
			_push(`</a>`);
			if (__props.educations.length) {
				_push(`<div class="edu-list" data-v-3873ffb0><!--[-->`);
				ssrRenderList(__props.educations, (edu) => {
					_push(`<div class="edu-item" data-v-3873ffb0><p class="edu-degree" data-v-3873ffb0>${ssrInterpolate(edu.degree)}</p><p class="edu-inst" data-v-3873ffb0>${ssrInterpolate(edu.institution)}</p><p class="edu-year" data-v-3873ffb0>${ssrInterpolate(edu.startYear)} – ${ssrInterpolate(edu.endYear)}</p></div>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`</div><div class="ct-column glass-panel" data-v-3873ffb0><h3 class="col-title" data-v-3873ffb0>Profiles &amp; Briefing</h3><div class="social-list" data-v-3873ffb0><!--[-->`);
			ssrRenderList(__props.socialLinks, (link) => {
				_push(`<a${ssrRenderAttr("href", link.url)} target="_blank" rel="noopener noreferrer" class="social-link" data-v-3873ffb0>`);
				ssrRenderVNode(_push, createVNode(resolveDynamicComponent(iconMap[link.platform] || unref(Mail)), { size: 16 }, null), _parent);
				_push(`<span data-v-3873ffb0>${ssrInterpolate(link.label)}</span>`);
			...
			_push(ssrRenderComponent(unref(link_default), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<span data-v-3873ffb0${_scopeId}>For Hiring Managers Brief</span>`);
						_push(ssrRenderComponent(unref(ExternalLink), {
							size: 12,
							class: "ext-icon"
			...
			_push(`</div></div><footer class="ct-column glass-panel" role="contentinfo" data-v-3873ffb0><h3 class="col-title" data-v-3873ffb0>Architecture &amp; Legal</h3><p class="credit-text" data-v-3873ffb0> Designed &amp; Developed by <span class="credit-name" data-v-3873ffb0>${ssrInterpolate(__props.profile.name)}</span></p><p class="credit-year" data-v-3873ffb0>© ${ssrInterpolate(unref(currentYear))}</p><div class="credit-legal" data-v-3873ffb0>`);
			_push(ssrRenderComponent(unref(link_default), {
				href: "/privacy",
				class: "legal-link"
			}, {
			...
			_push(`<span class="legal-sep" data-v-3873ffb0>·</span>`);
			_push(ssrRenderComponent(unref(link_default), {
				href: "/terms",
				class: "legal-link"
			}, {
			...
			_push(`</div><p class="credit-stack" data-v-3873ffb0> Built with VILT Stack <br data-v-3873ffb0><span class="stack-detail" data-v-3873ffb0>Vue 3 · Inertia.js · Laravel 13 · Tailwind CSS</span></p></footer></div><div class="ct-form-row glass-panel" data-v-3873ffb0><h3 class="form-title" data-v-3873ffb0>Send a message</h3>`);
			if (submitted.value) {
				_push(`<div class="form-success" role="status" aria-live="polite" data-v-3873ffb0><p data-v-3873ffb0>${ssrInterpolate(successMessage.value)}</p><p class="ai-prequalify-hint" data-v-3873ffb0>`);
				_push(ssrRenderComponent(unref(MessageSquare), {
					size: 14,
					class: "ai-hint-icon"
				}, null, _parent));
				_push(` While you wait, try the <button type="button" class="ai-hint-btn" data-v-3873ffb0>AI Assistant</button> to learn more about my experience and stack. </p></div>`);
			} else {
				_push(`<form class="contact-form" data-v-3873ffb0><p class="form-note" data-v-3873ffb0> Hiring, recruiting, or referring? Drop me a note and I&#39;ll reply within a business day. </p><div class="honeypot-wrap" aria-hidden="true" data-v-3873ffb0><label for="cf-company-website" data-v-3873ffb0>Company website</label><input id="cf-company-website"${ssrRenderAttr("value", unref(form).company_website)} type="text" tabindex="-1" autocomplete="off" data-v-3873ffb0></div><div class="form-row" data-v-3873ffb0><div class="form-field" data-v-3873ffb0><label for="cf-name" class="form-label" data-v-3873ffb0>Name</label><input id="cf-name"${ssrRenderAttr("value", unref(form).name)} type="text" class="${ssrRenderClass([{ "form-input-error": unref(form).errors.name }, "form-input"])}" placeholder="Your name or company" autocomplete="name" required data-v-3873ffb0>`);
				if (unref(form).errors.name) _push(`<span class="form-error" data-v-3873ffb0>${ssrInterpolate(unref(form).errors.name)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="form-field" data-v-3873ffb0><label for="cf-email" class="form-label" data-v-3873ffb0>Email</label><input id="cf-email"${ssrRenderAttr("value", unref(form).email)} type="email" class="${ssrRenderClass([{ "form-input-error": unref(form).errors.email }, "form-input"])}" placeholder="you@company.com" autocomplete="email" required data-v-3873ffb0>`);
				if (unref(form).errors.email) _push(`<span class="form-error" data-v-3873ffb0>${ssrInterpolate(unref(form).errors.email)}</span>`);
				else _push(`<!---->`);
				_push(`</div></div><div class="form-field" data-v-3873ffb0><label for="cf-project-type" class="form-label" data-v-3873ffb0>What brings you here?</label><select id="cf-project-type" class="form-input" required data-v-3873ffb0><option value="Full-Time Role" data-v-3873ffb0${ssrIncludeBooleanAttr(Array.isArray(unref(form).project_type) ? ssrLooseContain(unref(form).project_type, "Full-Time Role") : ssrLooseEqual(unref(form).project_type, "Full-Time Role")) ? " selected" : ""}>Full-time role</option><option value="Contract Role" data-v-3873ffb0${ssrIncludeBooleanAttr(Array.isArray(unref(form).project_type) ? ssrLooseContain(unref(form).project_type, "Contract Role") : ssrLooseEqual(unref(form).project_type, "Contract Role")) ? " selected" : ""}>Contract role</option><option value="Recruiter Intro" data-v-3873ffb0${ssrIncludeBooleanAttr(Array.isArray(unref(form).project_type) ? ssrLooseContain(unref(form).project_type, "Recruiter Intro") : ssrLooseEqual(unref(form).project_type, "Recruiter Intro")) ? " selected" : ""}>Recruiter / talent intro</option><option value="Referral" data-v-3873ffb0${ssrIncludeBooleanAttr(Array.isArray(unref(form).project_type) ? ssrLooseContain(unref(form).project_type, "Referral") : ssrLooseEqual(unref(form).project_type, "Referral")) ? " selected" : ""}>Referral</option><option value="Other" data-v-3873ffb0${ssrIncludeBooleanAttr(Array.isArray(unref(form).project_type) ? ssrLooseContain(unref(form).project_type, "Other") : ssrLooseEqual(unref(form).project_type, "Other")) ? " selected" : ""}>Other</option></select>`);
				if (unref(form).errors.project_type) _push(`<span class="form-error" data-v-3873ffb0>${ssrInterpolate(unref(form).errors.project_type)}</span>`);
				else _push(`<!---->`);
				_push(`</div><div class="form-field" data-v-3873ffb0><label for="cf-message" class="form-label" data-v-3873ffb0>Message</label><textarea id="cf-message" class="${ssrRenderClass([{ "form-input-error": unref(form).errors.message }, "form-input form-textarea"])}" placeholder="Tell me about the role, your team, technical challenges, or what you&#39;re building…" rows="4"${ssrRenderAttr("maxlength", MESSAGE_MAX)} required data-v-3873ffb0>${ssrInterpolate(unref(form).message)}</textarea><div class="form-field-footer" data-v-3873ffb0>`);
				if (unref(form).errors.message) _push(`<span class="form-error" data-v-3873ffb0>${ssrInterpolate(unref(form).errors.message)}</span>`);
				else _push(`<!---->`);
				_push(`<span class="${ssrRenderClass([{ "char-count--warn": messageNearLimit.value }, "char-count"])}" data-v-3873ffb0>${ssrInterpolate(messageCharCount.value)}/${ssrInterpolate(MESSAGE_MAX)}</span></div></div><button type="submit" class="form-submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-3873ffb0>${ssrInterpolate(unref(form).processing ? "Sending…" : "Send message")} `);
				_push(ssrRenderComponent(unref(ArrowUpRight), { size: 14 }, null, _parent));
				_push(`</button><p class="form-consent-note" data-v-3873ffb0> By submitting, you agree to direct communication regarding your inquiry per our `);
				_push(ssrRenderComponent(unref(link_default), {
					href: "/privacy",
					class: "consent-link"
				}, {
			...
			_push(`</div><div class="ct-newsletter-row" data-v-3873ffb0><h3 class="nl-title" data-v-3873ffb0>Stay Updated</h3><p class="nl-desc" data-v-3873ffb0>Get notified about new articles and projects.</p>`);
...
var ContactSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ContactSection_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-3873ffb0"]]);
//#endregion
