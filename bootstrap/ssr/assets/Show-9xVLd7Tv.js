...
import { t as ArchitectureDiagram_default } from "./ArchitectureDiagram-Kxnh6ehf.js";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(head_default), { title: __props.caseStudy.seoTitle }, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<meta name="description"${ssrRenderAttr("content", __props.caseStudy.seoDescription)} data-v-b1681f56${_scopeId}><meta property="og:title"${ssrRenderAttr("content", __props.caseStudy.seoTitle)} data-v-b1681f56${_scopeId}><meta property="og:description"${ssrRenderAttr("content", __props.caseStudy.seoDescription)} data-v-b1681f56${_scopeId}><meta property="og:type" content="article" data-v-b1681f56${_scopeId}><meta property="og:url"${ssrRenderAttr("content", `https://ashishgupta.dev/case-studies/${__props.caseStudy.slug}`)} data-v-b1681f56${_scopeId}><meta property="og:site_name" content="Ashish Gupta" data-v-b1681f56${_scopeId}><meta name="twitter:card" content="summary_large_image" data-v-b1681f56${_scopeId}><meta name="twitter:title"${ssrRenderAttr("content", __props.caseStudy.seoTitle)} data-v-b1681f56${_scopeId}><meta name="twitter:description"${ssrRenderAttr("content", __props.caseStudy.seoDescription)} data-v-b1681f56${_scopeId}><link rel="canonical"${ssrRenderAttr("href", `https://ashishgupta.dev/case-studies/${__props.caseStudy.slug}`)} data-v-b1681f56${_scopeId}>`);
			...
			_push(`<div class="case-study-page" data-v-b1681f56><div class="reading-progress" style="${ssrRenderStyle({ width: readingProgress.value + "%" })}" aria-hidden="true" data-v-b1681f56></div><header class="hero-shell page-shell" data-v-b1681f56><div class="topbar" data-v-b1681f56>`);
			...
			_push(`<div class="topbar-links" data-v-b1681f56>`);
			_push(ssrRenderComponent(unref(link_default), {
				href: "/",
				class: "topbar-link"
			}, {
			...
			_push(`<button class="pdf-download-btn" aria-label="Download as PDF" data-v-b1681f56>`);
			_push(ssrRenderComponent(unref(Download), { size: 14 }, null, _parent));
			_push(`<span data-v-b1681f56>Download PDF</span></button>`);
			_push(ssrRenderComponent(ThemeToggle_default, { class: "topbar-link" }, null, _parent));
			_push(`</div></div><div class="hero-grid" data-v-b1681f56><div class="hero-copy" data-v-b1681f56><p class="eyebrow" data-v-b1681f56>Case Study</p><h1 data-v-b1681f56>${ssrInterpolate(__props.caseStudy.title)}</h1><p class="hero-summary" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.summary)}</p></div><aside class="hero-aside" data-v-b1681f56><div class="meta-block" data-v-b1681f56><span class="meta-label" data-v-b1681f56>Client</span><span class="meta-value" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.client)}</span></div><div class="meta-block" data-v-b1681f56><span class="meta-label" data-v-b1681f56>Role</span><span class="meta-value" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.role)}</span></div><div class="meta-block" data-v-b1681f56><span class="meta-label" data-v-b1681f56>Industry</span><span class="meta-value" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.industry)}</span></div><div class="meta-block" data-v-b1681f56><span class="meta-label" data-v-b1681f56>Timeline</span><span class="meta-value" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.timeline)}</span></div><div class="meta-block" data-v-b1681f56><span class="meta-label" data-v-b1681f56>Reading Time</span><span class="meta-value" data-v-b1681f56>${ssrInterpolate(__props.caseStudy.readingTimeMinutes)} min</span></div></aside></div><div class="signal-band" data-v-b1681f56><div data-v-b1681f56><span class="signal-label" data-v-b1681f56>Featured outcome</span><p data-v-b1681f56>${ssrInterpolate(__props.caseStudy.featuredOutcome)}</p></div><div class="signal-stack" data-v-b1681f56><!--[-->`);
			ssrRenderList(__props.caseStudy.stack, (item) => {
				_push(`<span class="stack-chip" data-v-b1681f56>${ssrInterpolate(item)}</span>`);
			});
			_push(`<!--]--></div></div></header><main class="page-shell article-shell" data-v-b1681f56><article class="article-card" data-v-b1681f56><div class="article-prose" data-v-b1681f56>${__props.caseStudy.bodyHtml ?? ""}</div></article>`);
			_push(ssrRenderComponent(ArchitectureDiagram_default, { slug: __props.caseStudy.slug }, null, _parent));
			_push(`<aside class="article-rail" data-v-b1681f56><div class="rail-card" data-v-b1681f56><span class="rail-label" data-v-b1681f56>Permission status</span><p data-v-b1681f56>${ssrInterpolate(__props.caseStudy.permissionStatus)}</p></div><div class="rail-card" data-v-b1681f56><span class="rail-label" data-v-b1681f56>Tags</span><div class="tag-grid" data-v-b1681f56><!--[-->`);
			ssrRenderList(__props.caseStudy.tags, (tag) => {
				_push(`<span class="tag-chip" data-v-b1681f56>${ssrInterpolate(tag)}</span>`);
			});
			_push(`<!--]--></div></div><div class="rail-card cta-card" data-v-b1681f56><span class="rail-label" data-v-b1681f56>Looking to Hire?</span><p data-v-b1681f56> I architect and ship production systems end-to-end. Open to Senior / Staff Full-Stack Architect and Engineering Lead roles. </p><div class="cta-card-actions" data-v-b1681f56>`);
			_push(ssrRenderComponent(unref(link_default), {
				href: "/#contact",
				class: "cta-link"
			}, {
			...
			_push(`<a href="/resume/ashish-gupta-resume.pdf" download="Ashish-Gupta-Resume.pdf" target="_blank" rel="noopener noreferrer" class="cta-link cta-link-secondary" data-v-b1681f56>Download Résumé (PDF)</a></div></div></aside></main></div><!--]-->`);
		};
	}
});
//#endregion
...
var Show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Show_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b1681f56"]]);
//#endregion
