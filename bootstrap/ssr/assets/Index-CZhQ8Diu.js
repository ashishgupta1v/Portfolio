...
import { n as useTheme, t as ThemeToggle_default } from "./ThemeToggle-DfWc0Skh.js";
...
var SplitHero_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-79b7278d><div class="hero-mesh" aria-hidden="true" data-v-79b7278d><div class="glow-orb glow-1" data-v-79b7278d></div><div class="glow-orb glow-2" data-v-79b7278d></div><div class="grid-overlay" data-v-79b7278d></div></div><div class="hero-container" data-v-79b7278d><div class="hero-content" data-v-79b7278d><div class="status-row" data-v-79b7278d><span class="status-pill available" data-v-79b7278d><span class="pulse-dot" data-v-79b7278d></span> Open to Full-Time · Senior / Staff Architect </span><span class="status-pill remote" data-v-79b7278d> Remote Worldwide · US/EU Overlap </span></div><p class="hero-eyebrow" data-v-79b7278d><span class="eyebrow-line" data-v-79b7278d></span> ${ssrInterpolate(__props.name.toUpperCase())}</p><h1 class="hero-headline" data-v-79b7278d> I architect scalable systems <span class="gradient-accent" data-v-79b7278d>&amp; production AI.</span></h1><div class="rotator-container" aria-live="polite" aria-atomic="true" data-v-79b7278d><p class="proof-line" data-v-79b7278d>${ssrInterpolate(proofLines[currentProofIndex.value])}</p></div><p class="hero-bio" data-v-79b7278d> Senior Full-Stack &amp; AI Systems Architect with <strong data-v-79b7278d>10+ years</strong> modernizing legacy healthcare and aviation monoliths into decoupled, domain-driven systems and engineering hallucination-resistant RAG platforms. </p><div class="cta-group" data-v-79b7278d><a${ssrRenderAttr("href", __props.resumeUrl || void 0)} download="Ashish-Gupta-Resume.pdf" class="btn-primary" data-v-79b7278d>`);
			_push(ssrRenderComponent(unref(Download), {
				class: "btn-icon",
				size: 18
			}, null, _parent));
			_push(`<span data-v-79b7278d>Download Résumé</span></a><a${ssrRenderAttr("href", __props.calendlyUrl || "https://calendly.com/ashishgupta1v/30min")} target="_blank" rel="noopener noreferrer" class="btn-secondary btn-calendly" data-v-79b7278d>`);
			_push(ssrRenderComponent(unref(Calendar), {
				class: "btn-icon text-amber-400",
				size: 17
			}, null, _parent));
			_push(`<span data-v-79b7278d>Book a 20-min call</span>`);
			_push(ssrRenderComponent(unref(ArrowUpRight), {
				class: "btn-icon-sub",
				size: 14
			}, null, _parent));
			_push(`</a><a href="#contact" class="btn-secondary" data-v-79b7278d>`);
			_push(ssrRenderComponent(unref(Mail), {
				class: "btn-icon",
				size: 17
			}, null, _parent));
			_push(`<span data-v-79b7278d>Get in touch</span></a><button type="button" class="btn-ai" aria-label="Open AI Assistant to ask questions about Ashish" data-v-79b7278d>`);
			_push(ssrRenderComponent(unref(Sparkles), {
				class: "btn-icon text-amber-400",
				size: 16
			}, null, _parent));
			_push(`<span data-v-79b7278d>Ask my AI</span>`);
			_push(ssrRenderComponent(unref(ArrowUpRight), {
				class: "btn-icon-sub",
				size: 14
			}, null, _parent));
			_push(`</button></div><div class="social-row" data-v-79b7278d><a${ssrRenderAttr("href", __props.linkedinUrl || void 0)} target="_blank" rel="noopener noreferrer" class="social-link" aria-label="LinkedIn Profile" data-v-79b7278d><svg class="social-svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor" data-v-79b7278d><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" data-v-79b7278d></path></svg><span data-v-79b7278d>LinkedIn</span></a><a${ssrRenderAttr("href", __props.githubUrl || void 0)} target="_blank" rel="noopener noreferrer" class="social-link" aria-label="GitHub Profile" data-v-79b7278d><svg class="social-svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor" data-v-79b7278d><path d="M12 2A10 10 0 0 0 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.87 1.52 2.34 1.07 2.91.83.1-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0 0 12 2z" data-v-79b7278d></path></svg><span data-v-79b7278d>GitHub</span></a><a href="/for-hiring-managers" class="social-link highlight" data-v-79b7278d><span data-v-79b7278d>Hiring Brief ↗</span></a></div></div><div class="hero-panel-wrapper" data-v-79b7278d><div class="hero-panel" role="region" aria-label="System Architecture Live Demo" data-v-79b7278d><div class="panel-header" data-v-79b7278d><div class="window-controls" data-v-79b7278d><span class="ctrl ctrl-red" data-v-79b7278d></span><span class="ctrl ctrl-yellow" data-v-79b7278d></span><span class="ctrl ctrl-green" data-v-79b7278d></span><span class="panel-title-tag" data-v-79b7278d>system-arch · live telemetry</span></div><div class="headshot-badge" title="Ashish Gupta" data-v-79b7278d>`);
			if (avatarLoaded.value && __props.avatarUrl) _push(`<img${ssrRenderAttr("src", __props.avatarUrl)} alt="Ashish Gupta" class="headshot-img" width="36" height="36" data-v-79b7278d>`);
			else _push(`<div class="monogram-fallback" data-v-79b7278d> AG </div>`);
			_push(`</div></div>`);
			if (__props.panelMode === "architecture") {
				_push(`<div class="arch-flow-body" data-v-79b7278d><div class="nodes-container" data-v-79b7278d><!--[-->`);
				ssrRenderList(archNodes, (node, idx) => {
					_push(`<div class="${ssrRenderClass([{ "is-active": activeNodeIndex.value === idx }, "arch-node-item"])}" data-v-79b7278d><div class="node-icon-box" style="${ssrRenderStyle({ "--node-color": node.color })}" data-v-79b7278d>`);
					ssrRenderVNode(_push, createVNode(resolveDynamicComponent(node.icon), {
						class: "node-icon",
						size: 18
					}, null), _parent);
					_push(`</div><div class="node-info" data-v-79b7278d><div class="node-title" data-v-79b7278d>${ssrInterpolate(node.label)}</div><div class="node-sub" data-v-79b7278d>${ssrInterpolate(node.sub)}</div></div><div class="node-status-indicator" data-v-79b7278d><span class="live-dot" data-v-79b7278d></span></div>`);
					if (idx < archNodes.length - 1) _push(`<div class="node-connector" aria-hidden="true" data-v-79b7278d><div class="connector-line" data-v-79b7278d><div class="${ssrRenderClass([{ "is-traveling": activeNodeIndex.value === idx }, "pulse-traveler"])}" data-v-79b7278d></div></div></div>`);
					else _push(`<!---->`);
					_push(`</div>`);
				});
				_push(`<!--]--></div><div class="panel-proof-strip" data-v-79b7278d><div class="proof-chip" data-v-79b7278d><span class="chip-val" data-v-79b7278d>\$1M/yr</span><span class="chip-lbl" data-v-79b7278d>Cloud Saved</span></div><div class="proof-chip" data-v-79b7278d><span class="chip-val" data-v-79b7278d>−30%</span><span class="chip-lbl" data-v-79b7278d>Trial Latency</span></div><div class="proof-chip" data-v-79b7278d><span class="chip-val" data-v-79b7278d>10+ Yrs</span><span class="chip-lbl" data-v-79b7278d>Experience</span></div><div class="proof-chip" data-v-79b7278d><span class="chip-val" data-v-79b7278d>&lt;1s</span><span class="chip-lbl" data-v-79b7278d>Target FCP</span></div></div></div>`);
			} else {
				_push(`<div class="products-montage-body" data-v-79b7278d><div class="product-slide" data-v-79b7278d><div class="product-image-container" data-v-79b7278d><img${ssrRenderAttr("src", __props.products[currentProductIndex.value].imageUrl)}${ssrRenderAttr("alt", __props.products[currentProductIndex.value].title)} class="product-image" loading="lazy" data-v-79b7278d><div class="product-badge" data-v-79b7278d>${ssrInterpolate(__props.products[currentProductIndex.value].tag)}</div></div><div class="product-meta" data-v-79b7278d><h2 class="product-name" data-v-79b7278d>${ssrInterpolate(__props.products[currentProductIndex.value].title)}</h2><p class="product-desc" data-v-79b7278d>${ssrInterpolate(__props.products[currentProductIndex.value].description)}</p>`);
				if (__props.products[currentProductIndex.value].url) {
					_push(`<a${ssrRenderAttr("href", __props.products[currentProductIndex.value].url)} target="_blank" rel="noopener noreferrer" class="product-link" data-v-79b7278d><span data-v-79b7278d>Visit Live System</span>`);
					_push(ssrRenderComponent(unref(ExternalLink), { size: 14 }, null, _parent));
					_push(`</a>`);
				} else _push(`<!---->`);
				_push(`</div></div></div>`);
			}
			_push(`</div></div></div><div class="scroll-cue" aria-hidden="true" data-v-79b7278d><a href="#about" class="scroll-link" data-v-79b7278d><span class="scroll-text" data-v-79b7278d>SCROLL TO EXPLORE</span>`);
...
var SplitHero_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SplitHero_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-79b7278d"]]);
//#endregion
...
var Index_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const AboutSection = defineAsyncComponent({
			loader: () => import("./AboutSection-C8Nwo9Jk.js"),
			...asyncOpts
		});
		const TimelineSection = defineAsyncComponent({
			loader: () => import("./TimelineSection-CEqiZ5ww.js"),
			...asyncOpts
		});
		const WorksSection = defineAsyncComponent({
			loader: () => import("./WorksSection-7ubYUhdu.js"),
			...asyncOpts
		});
		const MetricsSection = defineAsyncComponent({
			loader: () => import("./MetricsSection-DNZILzcD.js"),
			...asyncOpts
		});
		const TestimonialsSection = defineAsyncComponent({
			loader: () => import("./TestimonialsSection-Cv0DDtp6.js"),
			...asyncOpts
		});
		const FeaturedCaseStudySection = defineAsyncComponent({
			loader: () => import("./FeaturedCaseStudySection-CSPeWDZ7.js"),
			...asyncOpts
		});
		const TechStackSection = defineAsyncComponent({
			loader: () => import("./TechStackSection-BSAZvsjB.js"),
			...asyncOpts
		});
		const GitHubActivity = defineAsyncComponent({
			loader: () => import("./GitHubActivity-P4701fei.js"),
			...asyncOpts
		});
		const ContactSection = defineAsyncComponent({
			loader: () => import("./ContactSection-V6pJqLQ8.js"),
			...asyncOpts
		});
		const props = __props;
