	...
	setup(__props) {
		...
		function initCluster() {
			...
			for (let i = 0; i < count; i++) {
				...
				const lenMultiplier = textLen > 16 ? 1.4 : textLen > 10 ? 1.2 : 1;
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({
				...
				id: "tech",
				class: "ts-section"
			}, _attrs))} data-v-701f60fd><div class="ts-shell" data-v-701f60fd><div class="section-header" data-v-701f60fd><div class="section-header-wrapper" data-v-701f60fd><h2 class="section-title" data-v-701f60fd><span class="section-title-word" data-v-701f60fd>Tech</span><span class="section-title-word accent" data-v-701f60fd>Stack</span></h2></div><div class="section-separator" data-v-701f60fd></div></div><div class="bubble-field" data-v-701f60fd><!--[-->`);
			ssrRenderList(stackSkills, (skill, index) => {
				_push(`<div class="bubble-wrapper" style="${ssrRenderStyle({
					"--size": skill.size,
					"--hue": skill.hue
				})}" data-v-701f60fd><div class="bubble" data-v-701f60fd><span class="bubble-text" data-v-701f60fd>${ssrInterpolate(skill.name)}</span></div></div>`);
			});
			_push(`<!--]--></div><div class="tech-grouped-grid" data-v-701f60fd><!--[-->`);
			ssrRenderList(skillCategories, (cat) => {
				_push(`<div class="tech-group-card glass-panel" data-v-701f60fd><h3 class="tech-group-title" data-v-701f60fd><span class="tech-group-dot" style="${ssrRenderStyle({ background: cat.color })}" data-v-701f60fd></span> ${ssrInterpolate(cat.name)}</h3><div class="tech-chips-wrap" data-v-701f60fd><!--[-->`);
				ssrRenderList(cat.skills, (skill) => {
					_push(`<span class="tech-chip-item glow-pill" data-v-701f60fd>${ssrInterpolate(skill)}</span>`);
				});
				_push(`<!--]--></div></div>`);
			});
...
var TechStackSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(TechStackSection_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-701f60fd"]]);
//#endregion
