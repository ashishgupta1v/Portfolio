...
var Show_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<main class="project-page" data-v-a33afe1a><div class="project-shell" data-v-a33afe1a>`);
			_push(ssrRenderComponent(unref(link_default), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<span data-v-a33afe1a${_scopeId}>All work</span>`);
			...
			_push(`<header class="project-header" data-v-a33afe1a><span class="project-category" data-v-a33afe1a>${ssrInterpolate(__props.project.category)}</span><h1 class="project-title" data-v-a33afe1a>${ssrInterpolate(__props.project.title)}</h1><p class="project-description" data-v-a33afe1a>${ssrInterpolate(__props.project.description)}</p><div class="project-actions" data-v-a33afe1a>`);
			if (__props.project.externalUrl) {
				_push(`<a${ssrRenderAttr("href", __props.project.externalUrl)} target="_blank" rel="noopener noreferrer" class="project-cta project-cta--primary" data-v-a33afe1a><span data-v-a33afe1a>Visit live site</span>`);
			...
			if (__props.caseStudySlug) _push(ssrRenderComponent(unref(link_default), {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span data-v-a33afe1a${_scopeId}>Read architecture case study</span>`);
			...
			_push(`<a href="mailto:ashishgupta1v@gmail.com" class="project-cta project-cta--ghost" data-v-a33afe1a><span data-v-a33afe1a>Contact Ashish</span>`);
			_push(ssrRenderComponent(unref(ArrowUpRight), {
				size: 14,
				"aria-hidden": "true"
			}, null, _parent));
			...
			if (__props.project.imageUrl) {
				_push(`<section class="project-media" aria-label="Project preview" data-v-a33afe1a>`);
			...
			_push(`<section class="project-details" data-v-a33afe1a><div data-v-a33afe1a><h2 class="project-h2" data-v-a33afe1a>Stack &amp; tooling</h2><ul class="project-tools" data-v-a33afe1a><!--[-->`);
			ssrRenderList(__props.project.tools, (tool) => {
				_push(`<li class="project-tool" data-v-a33afe1a>${ssrInterpolate(tool)}</li>`);
			});
			_push(`<!--]--></ul></div><div data-v-a33afe1a><h2 class="project-h2" data-v-a33afe1a>Role &amp; Opportunity</h2><p class="project-body" data-v-a33afe1a> Looking for a Senior / Staff Full-Stack Architect who can lead technical initiatives, design scalable systems, and execute end-to-end with high velocity? </p><p class="project-body" data-v-a33afe1a>`);
			_push(ssrRenderComponent(unref(link_default), {
				href: "/#contact",
				class: "inline-link"
			}, {
			...
			_push(`  ·  <a${ssrRenderAttr("href", resumeUrl)} download="Ashish-Gupta-Resume.pdf" target="_blank" rel="noopener noreferrer" class="inline-link" data-v-a33afe1a>Download Résumé</a></p></div></section></div></main><!--]-->`);
		};
	}
});
//#endregion
...
var Show_default = /* @__PURE__ */ _plugin_vue_export_helper_default(Show_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-a33afe1a"]]);
//#endregion
