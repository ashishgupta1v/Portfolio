    ...
    private function seedProjects(Profile $profile): void
    {
        $projects = [
            [
                ...
                'metric_badge' => 'Sub-Second pgvector RAG · Approval Queue',
                'description' => 'A production WhatsApp-first accountability platform combining pgvector RAG (1,536-dim embeddings, HNSW index), multi-tier prompt injection defense, an asynchronous Human-in-the-Loop Approval Queue, and an immutable Trust & Audit Log.',
                'solution' => 'Production pgvector RAG pipeline + prompt-injection defense + asynchronous coach approval queue.',
