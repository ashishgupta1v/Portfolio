    ...
    private function seedProjects(Profile $profile): void
    {
        $projects = [
            [
                ...
                'description' => 'AI-Driven Transformation Engine: Architected a gamified habit-tracking and Hinglish microlearning platform designed to facilitate personal transformation and behavioral growth. Engineered a "Warrior Point Ledger" and a robust point-based gamification system to incentivize user consistency and track habit formation.',
                'tools' => ['Laravel 12', 'Vue 3', 'Inertia.js', 'Tailwind CSS', 'OpenAI API', 'PostgreSQL'],
                'image_url' => null,
                'video_url' => null,
                'external_url' => null,
                'sort_order' => 1,
