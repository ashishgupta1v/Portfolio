...
export const SHOWCASE_PROJECTS: ShowcaseProject[] = [
    {
        ...
        metrics: ['Sub-Second pgvector RAG', 'Approval Queue Oversight', 'Zero Injection Breaches'],
        ...
        tech: ['Laravel 13', 'pgvector (HNSW 1536d)', 'OpenAI RAG', 'Human-in-the-Loop', 'Prompt Defense', 'WhatsApp Cloud API'],
