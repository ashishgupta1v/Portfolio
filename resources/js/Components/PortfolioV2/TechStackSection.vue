...
const stackSkills: BubbleSkill[] = [
    { name: 'Vue 3', hue: 160, size: 1.26 },
    { name: 'Laravel 13', hue: 8, size: 1.3 },
    { name: 'TypeScript', hue: 212, size: 1.26 },
    { name: 'RAG Systems', hue: 280, size: 1.28 },
    { name: 'pgvector', hue: 260, size: 1.22 },
    { name: 'OpenAI API', hue: 170, size: 1.2 },
    { name: 'Claude Code', hue: 36, size: 1.15 },
    { name: 'AI Agents', hue: 295, size: 1.14 },
    { name: 'Domain Driven Design', hue: 210, size: 1.2 },
    { name: 'PHP 8.4', hue: 240, size: 1.22 },
    { name: 'PostgreSQL', hue: 205, size: 1.3 },
    { name: 'Inertia.js', hue: 258, size: 1.24 },
    { name: 'Tailwind CSS', hue: 190, size: 1.15 },
    { name: 'Python', hue: 215, size: 1.1 },
    { name: 'Node.js', hue: 120, size: 1.08 },
    { name: 'MySQL', hue: 200, size: 1.04 },
    { name: 'Redis', hue: 0, size: 1.12 },
    { name: 'Docker', hue: 204, size: 1.0 },
    { name: 'AWS', hue: 38, size: 0.96 },
    { name: 'Vite', hue: 238, size: 0.92 },
    { name: 'SOLID', hue: 164, size: 0.89 },
    { name: 'Microservices', hue: 222, size: 0.96 },
    { name: 'RESTful APIs', hue: 2, size: 0.94 },
    { name: 'Nginx', hue: 134, size: 0.82 },
    { name: 'GitHub Actions', hue: 215, size: 0.85 },
