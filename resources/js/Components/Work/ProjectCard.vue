...
:global([data-theme="light"]) .work-card {
    ...
    box-shadow: 0 4px 20px -2px rgba(15, 23, 42, 0.06), 0 0 0 1px rgba(15, 23, 42, 0.04);
}

:global([data-theme="light"]) .work-card:hover {
...
:global([data-theme="light"]) .btn-action--quickview:hover {
    background: #ffffff;
    border-color: #0d9488;
    color: #0d9488;
}
